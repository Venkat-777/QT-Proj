...
******************************************************************************/
//Shape::Shape(int id, ShapeType shape) : id { id }, shape { shape } {}
...
******************************************************************************/
Shape::Shape(int id, ShapeType shape, QPen pen, QBrush brush)
    : id { id }, shape { shape }, pen { pen }, brush { brush } {}
...
Shape::Shape(Shape&& rhs) noexcept
    : shape { std::move(rhs.shape) }, id { std::move(rhs.id) },
